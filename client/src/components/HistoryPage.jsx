...
//           <span>Total: {history.length} items</span>
//           {searchTerm && (
//             <span>Filtered: {filteredHistory.length} items</span>
//           )}
//         </div>
//       </div>
...
//             <h3 className="text-xl font-bold text-gray-800 mb-4">Clear All History?</h3>
...
//               className="px-6 py-3 bg-primary text-white rounded-md hover:bg-blue-700"
//             >
//               Upload Document
//             </button>
//           )}
...
//                     <div>
//                       <p className="font-medium text-gray-700">Referral To:</p>
//                       <p>{item.extracted?.referral?.referral_to || '-'}</p>
//                     </div>
//                     <div>
//                       <p className="font-medium text-gray-700">File Number:</p>
//                       <p>{item.extracted?.file_number || '-'}</p>
//                     </div>
