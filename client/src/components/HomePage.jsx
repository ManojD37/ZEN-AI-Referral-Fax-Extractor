...
//                                 rounded-full text-xl font-bold mb-4">
//                     {item.step}
//                   </div>
...
//                 <div
//                   key={format}
//                   className="flex items-start space-x-3 p-4 bg-gray-50 rounded-md"
//                 >
...
//             © 2025 Medical Referral Extractor. Powered by Azure OpenAI.
//           </p>
//         </div>
//       </footer>
//     </div>
